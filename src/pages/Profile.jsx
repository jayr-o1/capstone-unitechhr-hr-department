...
const Profile = () => {
  ...
  const confirmSave = async () => {
    ...
    const updateData = {
      ...
      profilePicture: profilePicture !== profileImage ? profilePicture : undefined,
        ...
        <div className="w-full flex flex-col md:flex-row">
          <div className="md:w-1/3 flex justify-center mb-6 md:mb-0">
            <div className="flex flex-col items-center">
              <div 
                className={`w-60 h-60 rounded-lg overflow-hidden bg-gray-200 mb-4 border-2 ${editMode ? 'border-blue-500 cursor-pointer' : 'border-gray-300'} relative group`}
              ...
              >
                ...
                {editMode && (
                  <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="text-white text-sm font-medium px-2 py-1 rounded">Click to change photo</span>
                  </div>
                )}
                <input
                  type="file"
                ...
                <div className="relative">
                  ...
                  <div className="relative flex">
                    <input
                      ...
                      className={`w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 ${!editMode ? 'bg-gray-100' : ''}`}
                      required
                      disabled={!editMode}
                    />
                    {!editMode && (
