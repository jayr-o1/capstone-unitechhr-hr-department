...
const JobDetails = () => {
    ...
    const {
        jobs,
        handleUpdateJob: updateJobInContext,
        removeJob,
        loading,
        error,
                        ...
                        <div className="border border-gray-300 rounded-lg p-6 bg-white shadow-md">
                            ...
                            <div className="rounded-lg">
                                ...
                                <div className="mb-6">
                                    ...
                                    <ul className="list-disc ml-6 text-gray-700 space-y-2">
                                        {Array.isArray(jobDetails.keyDuties) ? (
                                            jobDetails.keyDuties.map(
                                                (duty, index) => (
                                                    <li key={index}>{duty}</li>
                                                )
                                            )
                                        ) : typeof jobDetails.keyDuties ===
                                          "string" ? (
                                            jobDetails.keyDuties
                                                .split("\n")
                                ...
                                <div className="mb-6">
                                    ...
                                    <ul className="list-disc ml-6 text-gray-700 space-y-2">
                                        {Array.isArray(
                                            jobDetails.essentialSkills
                                        ) ? (
                                            jobDetails.essentialSkills.map(
                                                (skill, index) => (
                                                    <li key={index}>{skill}</li>
                                                )
                                            )
                                        ) : typeof jobDetails.essentialSkills ===
                                          "string" ? (
                                            jobDetails.essentialSkills
                                                .split("\n")
                                                .filter((item) => item.trim())
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc ml-6 text-gray-700 space-y-2">
                                        ...
                                        ) : typeof jobDetails.qualifications ===
                                          "string" ? (
                                            jobDetails.qualifications
                                                .split("\n")
                                                .filter((item) => item.trim())
