...
const EmployeeDetails = () => {
    ...
    if (loading) {
        ...
        return <PageLoader message="Loading employee details..." contentOnly={!isPageRefresh} fullscreen={isPageRefresh} />;
    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center">
                                        <p className="font-medium mr-2">{employee.employeeId || "N/A"}</p>
                                        {employee.employeeId && (
                                            <button
                                                onClick={() => copyToClipboard(employee.employeeId, "Employee ID copied to clipboard!")}
                    ...
                    <div className="col-span-1 md:col-span-3">
                        ...
                        <div className="border border-gray-300 rounded-lg p-6 bg-white shadow-sm">
                                ...
                                <>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                        <div>
                                            ...
                                            <p className="font-medium">{employee.bankDetails.bankName || "N/A"}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Account Number</p>
                                            <p className="font-medium">{employee.bankDetails.accountNumber || "N/A"}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Routing Number</p>
                                            <p className="font-medium">{employee.bankDetails.routingNumber || "N/A"}</p>
                                        </div>
                                    </div>
                                </>
                            )}
                            ...
                            {/* Onboarding Progress */}
                            {employee.onboardingChecklist && employee.onboardingChecklist.length > 0 && (
                                <>
                                    <hr className="border-t border-gray-200 my-6" />
                                    ...
                                    <div className="space-y-3">
                                        {employee.onboardingChecklist.map((item) => (
                                            <div key={item.id} className="flex items-center gap-3">
                                                <div className={`w-5 h-5 rounded-full flex items-center justify-center ${item.completed ? 'bg-green-500' : 'bg-gray-200'}`}>
                                                    {item.completed && (
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {employee.documents.map((document) => (
                                                <tr key={document.id} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                                        {formatDate(document.uploadedAt?.toDate?.() || document.uploadedAt)}
                                                    </td>
                                                    <td className="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                                        <div className="flex justify-end space-x-2">
                                                            <button
                                                                onClick={() => handleDocumentDownload(document.downloadURL, document.fileName, document)}
