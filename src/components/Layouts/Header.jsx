...
const NotificationDropdown = ({ notifications, markAsRead, setNotifications }) => {
...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 bg-white shadow-sm px-4 py-2 flex items-center justify-between z-40 h-16 md:pl-64 md:pr-4">
