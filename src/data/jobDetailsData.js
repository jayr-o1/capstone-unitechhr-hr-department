const jobDetailsData = [
    {
      ...
      applicants: [
        {
          id: 1, // Unique ID for each applicant
          name: "John Doe",
        ...
        {
          id: 2, // Unique ID for each applicant
          name: "Jane Smith",
    ...
    },
    {
      ...
      applicants: [
        {
          id: 3, // Unique ID for each applicant
          name: "Alice Johnson",
    ...
    },
    {
      ...
      keyDuties: ["Teach criminology concepts", "Prepare forensic case studies"],
      essentialSkills: [
        "Knowledge of forensic science",
        "Understanding of criminal law",
      ],
      qualifications: ["Bachelor’s in Criminology", "Law enforcement experience"],
      salary: "Up to 20k",
      workSetup: "On Site",
      datePosted: "1 day ago",
      availableSlots: 1,
    ...
    },
    {
      ...
      applicants: [
        {
          id: 4, // Unique ID for each applicant
          name: "Bob Brown",
    ...
    },
    {
      ...
      applicants: [
        {
          id: 5, // Unique ID for each applicant
          name: "Charlie Davis",
    ...
    },
    {
      ...
      applicants: [
        {
          id: 6, // Unique ID for each applicant
          name: "Eve Wilson",
    ...
    },
    {
      ...
      essentialSkills: ["Microsoft Office", "Organization", "Time management"],
      qualifications: ["Associate’s or Bachelor’s in Business Administration"],
      salary: "Up to 15k",
      workSetup: "On Site",
    ...
    },
    {
      ...
      applicants: [
        {
          id: 7, // Unique ID for each applicant
          name: "Frank Moore",
