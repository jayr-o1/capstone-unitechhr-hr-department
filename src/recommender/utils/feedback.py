"""
Feedback handling module for the recommender system.
This module contains functions for storing, retrieving, and applying user feedback.
"""
...
# Define the path for feedback database
FEEDBACK_DB_PATH = "../data/user_feedback.json"
